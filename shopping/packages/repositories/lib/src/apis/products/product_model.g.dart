...
abstract class _$ProductModelCWProxy {
  ...
  ProductModel call({
    ...
    ProductMetaData? reviewMetaData,
  });
}

/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfProductModel.copyWith(...)`.
class _$ProductModelCWProxyImpl implements _$ProductModelCWProxy {
  ...
  ProductModel call({
    ...
    Object? shopId = const $CopyWithPlaceholder(),
    ...
    Object? reviewMetaData = const $CopyWithPlaceholder(),
  }) {
    return ProductModel(
      productId: productId == const $CopyWithPlaceholder()
          ...
          : productId as String?,
      shopId: shopId == const $CopyWithPlaceholder() || shopId == null
          ? _value.shopId
          // ignore: cast_nullable_to_non_nullable
          : shopId as String,
      ...
      reviewMetaData: reviewMetaData == const $CopyWithPlaceholder() ||
              reviewMetaData == null
          ? _value.reviewMetaData
          // ignore: cast_nullable_to_non_nullable
          : reviewMetaData as ProductMetaData,
    );
  }
}

extension $ProductModelCopyWith on ProductModel {
  /// Returns a callable class that can be used as follows: `instanceOfProductModel.copyWith(...)`.
...
ProductModel _$ProductModelFromJson(Map<String, dynamic> json) => ProductModel(
      ...
      reviewMetaData: json['reviewMetaData'] == null
          ? const ProductMetaData()
          : ProductMetaData.fromJson(
              json['reviewMetaData'] as Map<String, dynamic>),
    );
