...
class AppThemeData {
  ...
  ThemeData get themeData => ThemeData(
      ...
      filledButtonTheme: FilledButtonThemeData(
          style: ElevatedButton.styleFrom(
              fixedSize: const Size(double.maxFinite, 48), shape: decoration.roundedBorder())),
      ...
      buttonTheme:
          ButtonThemeData(minWidth: double.maxFinite, height: 46, shape: decoration.roundedBorder()));
  ...
  TextStyle get primaryUserMessageContentStyle => TextStyle(fontSize: primaryUserMsgBodyFs);
  TextStyle get primaryUserMessageCaptionStyle => TextStyle(fontSize: primaryUserMsgCaptionFs);
  TextStyle get clientMessageContentStyle => TextStyle(fontSize: clientMsgBodyFs);

  TextStyle get clientMessageCaptionStyle => TextStyle(fontSize: clientMsgCaptionFs);

  TextStyle get messageTitleStyle => TextStyle(fontSize: clientMsgBodyFs, fontWeight: FontWeight.w500);

  TextStyle get replyContentStyle => TextStyle(fontSize: replyBodyFs);
  TextStyle get replyTitleStyle => TextStyle(fontSize: replyTitleFs, fontWeight: defMedium);
}
