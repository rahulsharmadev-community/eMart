...
class GoogleOAuthButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var bgColor = brightness == Brightness.dark ? Colors.black : Colors.white;
    var text = Text(label);
  ...
  SvgPicture resolveIcon(bgColor) {
    return SvgPicture.string(_iconSvg,
...
<svg width="38px" height="38px" viewBox="0 0 38 38" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	<g id="Google-Button" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		<g id="btn_google_signin_dark_normal" transform="translate(-5.000000, -5.000000)">
			<rect id="button-bg-copy" fill="none" x="5" y="5" width="38" height="38" rx="1"/>
