...
abstract class _$ProductCWProxy {
  ...
  Product productReviews(List<String> productReviews);
...
class _$ProductCWProxyImpl implements _$ProductCWProxy {
  ...
  @override
  Product views(int views) => this(views: views);
  ...
  Product call({
    ...
    Object? productReviews = const $CopyWithPlaceholder(),
    ...
    return Product(
      ...
      productReviews: productReviews == const $CopyWithPlaceholder() ||
              productReviews == null
          ? _value.productReviews
          // ignore: cast_nullable_to_non_nullable
          : productReviews as List<String>,
...
ReviewMetaData _$ReviewMetaDataFromJson(Map<String, dynamic> json) =>
    ReviewMetaData(
...
Map<String, dynamic> _$ReviewMetaDataToJson(ReviewMetaData instance) =>
    <String, dynamic>{
