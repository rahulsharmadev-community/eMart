...
AppMetaData _$AppMetaDataFromJson(Map<String, dynamic> json) => AppMetaData(
      (json['categories'] as List<dynamic>)
          ...
          .toList(),
      (json['publicCategories'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      json['gloabalAlertBanner'] == null
          ? null
          : AlertModel.fromJson(
              json['gloabalAlertBanner'] as Map<String, dynamic>),
      json['localAlertBanner'] == null
          ? null
          : LocalAlertBanner.fromJson(
              json['localAlertBanner'] as Map<String, dynamic>),
      json['producHighReturnAlertBanner'] == null
          ? null
          : AlertModel.fromJson(
              json['producHighReturnAlertBanner'] as Map<String, dynamic>),
      json['orderProgressAlertBanner'] == null
          ? null
          : AlertModel.fromJson(
              json['orderProgressAlertBanner'] as Map<String, dynamic>),
      json['liveCountdownBanner'] == null
          ? null
          : LiveCountdownModel.fromJson(
              json['liveCountdownBanner'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$AppMetaDataToJson(AppMetaData instance) =>
    <String, dynamic>{
      ...
      'producHighReturnAlertBanner':
          instance.producHighReturnAlertBanner?.toJson(),
      'orderProgressAlertBanner': instance.orderProgressAlertBanner?.toJson(),
      'liveCountdownBanner': instance.liveCountdownBanner?.toJson(),
    };

LocalAlertBanner _$LocalAlertBannerFromJson(Map<String, dynamic> json) =>
    LocalAlertBanner(
      homeScreen: json['homeScreen'] == null
          ? null
          : AlertModel.fromJson(json['homeScreen'] as Map<String, dynamic>),
      ...
      cartScreen: json['cartScreen'] == null
          ? null
          : AlertModel.fromJson(json['cartScreen'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$LocalAlertBannerToJson(LocalAlertBanner instance) =>
    <String, dynamic>{
